    ...
    <div>
      ...
      <div className="pl-3 pr-3 lg:pl-40 lg:pr-40">
        <div className="flex flex-col items-center my-40 lg:pl-40 lg:pr-40">
          ...
          <p className="text-center lg:pl-20 lg:pr-20 text-lg lg:text-2xl lg:leading-relaxed">
        ...
        <div className="my-10">
          ...
          <div className="lg:flex">
            ...
            <div className="lg:w-1/2 text-center lg:py-5 lg:px-10">
              <p className="m-0 text-lg lg:text-2xl lg:leading-relaxed">
              ...
              <p className="mt-5 text-lg lg:text-2xl lg:leading-relaxed">
